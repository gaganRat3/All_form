...
urlpatterns = [
    ...
    path('divorce-sammelan-form/', views_divorce_sammelan.divorce_sammelan_form_view, name='divorce_sammelan_form'),
        ...
        path('37th-sammelan-mumbai-maharashtra/success/', __import__('biodata.views_37th_sammelan').views_37th_sammelan.sammelan_37_mumbai_maharashtra_success, name='37th_sammelan_mumbai_maharashtra_success'),
