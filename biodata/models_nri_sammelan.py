...
class NriSammelanBiodata(models.Model):
    RESIDENCE_CHOICES = [
    ...
    photo = models.ImageField(upload_to='nri_sammelan_photos/')
    ...
    class Meta:
        verbose_name = 'NRI Sammelan Biodata'
        verbose_name_plural = 'NRI Sammelan Biodata'